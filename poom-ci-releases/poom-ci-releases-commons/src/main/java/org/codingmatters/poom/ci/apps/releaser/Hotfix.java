...
public class Hotfix {
    ...
    public Hotfix(String repositoryUrl, PropagationContext propagationContext, CommandHelper commandHelper, Workspace workspace) {
    ...
    public ArtifactCoordinates initiate() throws CommandFailed {
        ...
        System.out.println("\n\n\n\n####################################################################################");
        System.out.printf("Starting hotfix of %s with context :\n", coordinates.coodinates());
        ...
        System.out.println("\n\n####################################################################################");
        System.out.println("Ready for hotfix...");
        System.out.println("####################################################################################\n\n");
